  ...
  return (
    <div className="special-selected">
      ...
      <h2 className="text-xl text-red-600 font-bold">
        10일간 타사이트를 통해 수입하셔서는 안됩니다
      </h2>
      <p>개인 무관세 한도(150불)이하로 공동구매합니다.</p>
      <p>따라서 고객님이 타사이트에서 주문한 것과 통관시점이 겹칠 경우</p>
      <p>
        불필요한 관세가 발생하며, 이는 고객님의 귀책 사유로 고객님께서
        부담하셔야 합니다
      </p>
      <br />
      <h2 className="text-xl text-red-600 font-bold">
      ...
      <div className="font-bold underline">
        고객님께는 선배송 해드리기 때문에 통관된 공동구매 상품들은 저희 소유가
        됩니다
      </div>
      <br />
      <h2 className="text-xl text-red-600 font-bold">통관 안내 문자안내</h2>
      <p>통관 시점에 세관에서 안내 문자가 고객님께 발송 됩니다</p>
